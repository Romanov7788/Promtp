export function createPrompt_adjective(params) {
    ...
    **Rules to ensure logical consistency**:
    - Only create pairs where the adjective is logically applicable to the noun. For example, "naughty" can be paired with "child" or "dog" but not "table" or "car".
    - The context of the adjective should make sense when paired with the noun. Avoid combinations that do not reflect natural language usage.
